...
// import 'package:quiz/app/module/view/components/quiz_header.dart';
// import 'package:quiz/app/module/view/view_model/quiz_provider.dart';
// import 'package:quiz/app/module/view/view_model/timer_provider.dart';
...
class _QuizScreenState extends State<QuizScreen> with TickerProviderStateMixin {
  ...
  void _onTimeExpired(QuizProvider quiz, TimerProvider timer) {
    if (quiz.answered) return;
    // Mark as wrong answer by passing -1 (or any invalid index)
    quiz.selectAnswer(-1);
  }
